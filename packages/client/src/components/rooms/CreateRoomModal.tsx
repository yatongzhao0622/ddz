        ...
        <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
          ...
          <div>
            <label className="flex items-center space-x-3 cursor-pointer">
              ...
              <div className="flex-1">
                <span className="text-sm font-medium text-gray-700">🔒 私人房间</span>
                <p className="text-xs text-gray-500">需要密码才能加入</p>
              </div>
            </label>
          </div>
          ...
          {formData.isPrivate && (
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">留空则无需密码</p>
            </div>
          )}
        </form>
